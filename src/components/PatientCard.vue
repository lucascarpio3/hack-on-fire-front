  ...
  <li class="card thumbnail bootsnipp-thumb row">
    <div class="row">
      ...
      <div class="form-group col-lg-2 col-sm-5 col-md-5 col-xs-5">
        ...
        <input type="number" class="form-control" name="age" id="age" v-model="value.idade" placeholder="Idade">
      </div>
      <div class="col-lg-5 col-sm-2 col-md-2 col-xs-3">
        <button @click="$emit('remove')" class=" btn btn-danger remove"><i class="fa fa-times" aria-hidden="true"></i></button>
      </div>
    </div>
    <div class="row">
      <div class="form-group col-sm-12">
        <label for="complaints">Queixas</label><br>
        <textarea id="complaints" class="form-control" cols="80" rows="3" v-model="value.queixas"
